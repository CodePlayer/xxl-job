...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected int storeExpressionVals(int pos, final String s, int type) throws ParseException {
        int incr = 0;
    ...
    protected int checkNext(int pos, final String s, int val, int type)
